...
def play_game():
  ...
  bet = int(
      input(f"You have ${player_balance}. How much would you like to bet? "))
  ...
  if user_hand[0] == user_hand[1]:
    split = input(
        "You have a pair. Would you like to split? Type 'y' or 'n': ")
    if split == 'y':
      hand1 = [user_hand[0], deal_card()]
      hand2 = [user_hand[1], deal_card()]
      print("Playing first hand...")
      hand1 = play_hand(hand1, bet, computer_hand)
      print("Playing second hand...")
      hand2 = play_hand(hand2, bet, computer_hand)
